                    ...
                    <div class="d-block border rounded mfliud-bot">
                        ...
                        <div class="dashboard_author">
                            ...
                            <ul class="dahs_navbar">
                                ...
                                <li><a href="{{ route('wishlist') }}"><i class="lni lni-heart me-2"></i>Wishlist</a></li>
                                <li><a href="{{ route('profile') }}"><i class="lni lni-user me-2"></i>Profile Info</a></li>
                                <li><a href="{{ route('addresses') }}" class="active"><i class="lni lni-map-marker me-2"></i>Addresses</a></li>
                ...
                @php
                    $addresses = [
                        [
                            ...
                            'first_name' => 'Frank',
                            'last_name' => 'Kodie',
                            'email' => 'frank@cylux.com',
                            'phone' => '0247202968',
                            'address1' => 'Dome, Accra',
                            'address2' => 'Christian Village',
                            'city' => 'Accra',
                            'zip' => '00233',
                            'country' => 'Ghana',
                        ],
                                ...
                                <div class="card-wrap border rounded mb-4">
                                    <div class="card-wrap-header px-3 py-2 br-bottom d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="card-head-last-flex d-flex align-items-center gap-2">
                                            <!-- Button -->
                                            <a href="#}" class="border p-3 circle text-dark d-inline-flex align-items-center justify-content-center">
                                                <i class="fas fa-pen-nib position-absolute"></i>
                                            </a>
                                            <!-- Button -->
                                            <a href="#" class="border bg-white text-danger p-3 circle text-dark d-inline-flex align-items-center justify-content-center">
                    ...
                    <div class="row align-items-start">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <a href="#" class="btn stretched-links borders full-width"><i class="fas fa-plus me-2"></i>Add New Address</a>
                            </div>
                        </div>
