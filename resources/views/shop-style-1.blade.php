<!-- resources/views/shops-style-1.blade.php -->
@extends('layouts.main')

@section('title', 'Shop-Style-1 Page')
...
<!-- Shop Style 1 -->
<section class="bg-cover" style="background:url({{ asset('assets/img/cover-1.jpg') }}) no-repeat;">
	<div class="container">
