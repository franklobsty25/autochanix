					...
					<div class="short_products_info_body mb-4">
						...
						<div class="single_search_boxed">
							<div class="widget-boxed-header">
								<h4><a href="#productinfo" data-bs-toggle="collapse" aria-expanded="false" role="button"><i class="ti-info me-2ti-info"></i>Product Info</a></h4>
							</div>
						...
						<div class="single_search_boxed">
							<div class="widget-boxed-header">
								<h4><a href="#choosecolor" data-bs-toggle="collapse" class="collapsed" aria-expanded="false" role="button"><i class="ti-paint-bucket me-2"></i>Choose Color's</a></h4>
							</div>
							<div class="widget-boxed-body collapse" id="choosecolor"  data-parent="#choosecolor">
						...
						<div class="single_search_boxed">
							<div class="widget-boxed-header">
								<h4><a href="#choosesize" data-bs-toggle="collapse" class="collapsed" aria-expanded="false" role="button"><i class="ti-view-list me-2"></i>Select Sizes</a></h4>
							</div>
