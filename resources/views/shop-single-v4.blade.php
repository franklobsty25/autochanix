<!-- resources/views/shops-single-v4.blade.php -->
@extends('layouts.main')

@section('title', 'Shop-Single-V4 Page')
		...
		<div class="row justify-content-between align-items-center">
			...
			<div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
				<div class="quick_view_slide">
					...
					<!-- includes/Product/shops-single-v4/image4.blade.php -->
					@include('includes.Product.shop-single-v4.image4')
