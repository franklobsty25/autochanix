				...
				<div class="col-lg-8 col-md-12 col-sm-12 col-12">
					<div class="article_detail_wrapss single_article_wrap format-standard">
						<div class="article_body_wrap">
							...
							<div class="article_featured_image">
								<img class="img-fluid" src="{{ !empty($item['img']) ? asset($item['img']) : asset('assets/img/bl-2.png') }}" alt="">
							</div>
					...
					<div class="article_detail_wrapss single_article_wrap format-standard">
						...
						<div class="article_posts_thumb">
							<span class="img"><img class="img-fluid" src="{{ asset('assets/img/team-1.jpg') }}" alt=""></span>
							...
							<div class="all-comments">
								...
								<div class="comment-list">
									<ul>
										...
										<!-- includes/blog-detail/5-comments.blade.php -->
										@include('includes.blog-detail.5-comments')
				...
				<div class="col-lg-4 col-md-12 col-sm-12 col-12">
					...
					<div class="single_widgets widget_category">
						...
						<ul>
							...
							<!-- includes/blog-detail/categories.blade.php -->
							@include('includes.blog-detail.categories')
					...
					<div class="single_widgets widget_thumb_post">
						...
						<ul>
							...
							<!-- includes/blog-detail/posts.blade.php -->
							@include('includes.blog-detail.posts')
