                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding: 24px 16px; background: #f8fafc; display: block; text-align: center;">
                            <img src="assets/img/order-success.svg" width="200px" alt="">
                            <h1 style="font-weight: 600; margin: 16px 0 0;">Thank you!</h1>
                        </td>
                    </tr>
                            ...
                            <table style="width: 100%; box-shadow: 0 0 3px rgba(60, 72, 88, 0.15); border-radius: 6px; background-color: #fff;">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="padding: 16px;">
                                            <span style="display: flex; align-items: center;">
                                                <img src="assets/img/product/1.jpg" style="width: 48px; box-shadow: 0 0 3px rgba(60, 72, 88, 0.15); border-radius: 6px;" alt="">
                                    ...
                                    <tr>
                                        <td style="padding: 16px;">
                                            <span style="display: flex; align-items: center;">
                                                <img src="assets/img/product/2.jpg" style="width: 48px; box-shadow: 0 0 3px rgba(60, 72, 88, 0.15); border-radius: 6px;" alt="">
                                                <span style="margin-left: 8px;">
                                    ...
                                    <tr>
                                        <td style="padding: 16px;">
                                            <span style="display: flex; align-items: center;">
                                                <img src="assets/img/product/3.jpg" style="width: 48px; box-shadow: 0 0 3px rgba(60, 72, 88, 0.15); border-radius: 6px;" alt="">
                                                <span style="margin-left: 8px;">
