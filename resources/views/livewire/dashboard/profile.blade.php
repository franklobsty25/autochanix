                    ...
                    <div class="d-block border rounded mfliud-bot">
                        ...
                        <div class="dashboard_author">
                            ...
                            <ul class="dahs_navbar">
                                ...
                                <li><a href="{{ route('wishlist') }}"><i class="lni lni-heart me-2" wire:navigate></i>Wishlist</a></li>
                                <li><a href="{{ route('profile') }}" class="active"><i class="lni lni-user me-2" wire:navigate></i>Profile</a></li>
                        ...
                        <form class="row g-3 m-0">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="calvinenglish@gmail.com" />
                                </div>
                            </div>
