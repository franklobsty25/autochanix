    ...
    <section class="middle">
        <div class="container">
            ...
            <div class="row align-items-center rows-products">
                ...
                @include('frontend.shops.components.product')
    ...
    <section class="px-0 py-3 br-top">
        <div class="container">
            <div class="row">
                ...
                <!-- frontend.shops.components.features.blade.php -->
                @include('frontend.shops.components.features')
