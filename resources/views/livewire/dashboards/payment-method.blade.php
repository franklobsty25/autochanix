<x-slot:title>Payment Method</x-slot>
<div>
    <!-- Top Breadcrubms -->
    <div class="gray py-3">
        <div class="container">
                    ...
                    <div class="d-block border rounded mfliud-bot">
                        ...
                        <div class="dashboard_author">
                            ...
                            <ul class="dahs_navbar">
                                ...
                                <li><a href="{{ route('payment-method') }}" class="active"><i class="lni lni-mastercard me-2"></i>Payment Method</a></li>
                ...
                <div class="col-12 col-md-12 col-lg-8 col-xl-8">
                    @php
                        $cards = [
                            [
                                'id' => 1,
                                'card_number' => 234578790480504,
                                'card_holder' => 'Autochanix',
                                'expire_month' => 'September',
                                'expire_year' => 2024 ,
                            ],
                        ];
                    @endphp
