            ...
            <div class="overflow-x-auto mt-6">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 border dark:border-gray-700">
                    ...
                    <tr class="border-b dark:border-gray-700 bg-white dark:bg-gray-900">
                        ...
                        <td class="px-6 py-3 text-gray-600 dark:text-gray-300">{{ $product->id }}</td>
                    </tr>
                    <tr class="border-b dark:border-gray-700 bg-white dark:bg-gray-900">
                        <th class="px-6 py-3 font-medium text-gray-900 dark:text-white whitespace-nowrap">Name</th>
                        <td class="px-6 py-3 text-gray-600 dark:text-gray-300">{{ $product->name }}</td>
                    </tr>
                    <tr class="border-b dark:border-gray-700 bg-white dark:bg-gray-900">
                        <th class="px-6 py-3 font-medium text-gray-900 dark:text-white whitespace-nowrap">Detail</th>
                        <td class="px-6 py-3 text-gray-600 dark:text-gray-300">{{ $product->detail }}</td>
                    </tr>
                    <tr class="border-b dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                        ...
                        <td class="px-6 py-3 text-gray-600 dark:text-gray-300">{{ \Carbon\Carbon::parse($product->created_at)->translatedFormat('d F Y l H:i:s') }}</td>
                    </tr>
                    <tr class="bg-white dark:bg-gray-900">
                        <th class="px-6 py-3 font-medium text-gray-900 dark:text-white whitespace-nowrap">{{ __('Updated At') }}</th>
                        <td class="px-6 py-3 text-gray-600 dark:text-gray-300">{{ \Carbon\Carbon::parse($product->updated_at)->translatedFormat('d F Y l H:i:s') }}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
