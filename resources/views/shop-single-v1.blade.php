<!-- resources/views/shops-single-v1.blade.php -->
@extends('layouts.main')

@section('title', 'Shop-Single-V1 Page')
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
                ...
                <div class="sp-wrap">
                    <a href="{{ !empty($item['img']) ? asset($item['img']) : asset('assets/img/product/16.png') }}"><img src="{{ !empty($item['img']) ? asset($item['img']) : asset('assets/img/product/16.png') }}" alt=""></a>
