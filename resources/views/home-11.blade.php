...
<div class="home-slider hide-navigation margin-bottom-0">
	...
	<!-- includes/Home/home-11/slide9.blade.php -->
	@include('includes.Home.home-11.slide9')
		...
		<div class="row g-0">
			...
			<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
				<div class="row no-gutters">
					...
					<!-- includes/Home/home-11/style3.blade.php -->
					@include('includes.Home.home-11.style3')
...
<section class="middle">
	<div class="container">
		...
		<div class="row align-items-center rows-products">
			...
			<!-- includes/Home/home-11/trendy2.blade.php -->
			@include('includes.Home.home-11.trendy2')
...
<!-- Deals of The Day -->
<section class="bg-cover" style="background:url({{ asset('assets/img/bg-3.jpg') }}) no-repeat;" data-overlay="3">
	<div class="container">
		<div class="row justify-content-center">
