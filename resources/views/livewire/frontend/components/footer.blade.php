...
new #[Layout('components.layouts.app.front-page')] class extends Component {}
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                    <div class="footer_widget">
                        ...
                        <div class="address mt-3">
                            ...
                            <div class="scr_payment"><img src="{{ asset('assets/img/card.png') }}" class="img-fluid"
                                                          alt=""/></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12 col-md-12 text-center">
                    {{-- <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Kumo. Develop with <i class="mdi mdi-heart text-danger"></i> By <a href="https://shreethemes.in/" target="_blank" class="text-reset">Shreethemes</a>.</p> --}}
                </div>
            </div>
        </div>
    </div>
