    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-7 col-lg-6 col-md-6 col-sm-12 hide-ipad">
                <div class="top_second"><p class="medium text-light m-0 p-0"><i class="ti-truck me-1"></i>Get Free delivery from $2000 <a href="#" class="medium text-light text-underline">Shop Now</a></p></div>
            </div>
            ...
            <div class="col-xl-5 col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="language-selector-wrapper dropdown js-dropdown float-right me-3">
                    ...
                    <ul class="dropdown-menu popup-content link">
                        <li class="current"><a href="javascript:void(0);" class="dropdown-item medium text-muted"><img src="{{ asset('assets/img/1.jpg') }}" alt="en" width="16" height="11" /><span>English</span></a></li>
                        <li><a href="javascript:void(0);" class="dropdown-item medium text-muted"><img src="{{ asset('assets/img/2.jpg') }}" alt="fr" width="16" height="11" /><span>Français</span></a></li>
                        <li><a href="javascript:void(0);" class="dropdown-item medium text-muted"><img src="{{ asset('assets/img/3.jpg') }}" alt="de" width="16" height="11" /><span>Deutsch</span></a></li>
                        <li><a href="javascript:void(0);" class="dropdown-item medium text-muted"><img src="{{ asset('assets/img/4.jpg') }}" alt="it" width="16" height="11" /><span>Italiano</span></a></li>
                        <li><a href="javascript:void(0);" class="dropdown-item medium text-muted"><img src="{{ asset('assets/img/5.jpg') }}" alt="es" width="16" height="11" /><span>Español</span></a></li>
                        <li ><a href="javascript:void(0);" class="dropdown-item medium text-muted"><img src="{{ asset('assets/img/6.jpg') }}" alt="ar" width="16" height="11" /><span>اللغة العربية</span></a></li>
                    </ul>
                </div>
                
                <div class="currency-selector dropdown js-dropdown float-right me-3">
                    <a href="javascript:void(0);" class="text-light medium"><i class="lni lni-user me-1"></i>Sign In / Register</a>
                </div>
                
                <div class="order-selector dropdown js-dropdown float-right me-3">
                    <a href="javascript:void(0);" class="text-light medium"><i class="lni lni-map-marker me-1"></i>Order Tracking</a>
                </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="headd-sty-wrap d-flex align-items-center justify-content-between py-3">
                            ...
                            <form class="bg-white rounded-md border-bold">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <div class="input-group-text p-0 border-0"><button class="btn bg-white text-danger custom-height rounded px-3" type="button"><i class="fas fa-search"></i></button></div>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <ul class="nav-menu nav-menu-social align-to-right align-items-center d-flex">
                            <li>
                                <div class="call d-flex align-items-center text-left">
                                    ...
                                    <span class="text-light small ms-3">Call Us Now:<strong class="d-block text-light fs-md">0(800) 123-456</strong></span>
                                </div>
                            </li>
                            <li>
                                <a href="javascript:void(0);" onclick="openWishlist()">
                                    <i class="far fa-heart fs-lg text-light"></i>
                                    <span class="wishlist-count dn-counter bg-dark">
                            ...
                            <li>
                                <a href="javascript:void(0);" onclick="openCart()">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <i class="fas fa-shopping-basket fs-lg text-light"></i>
                                        <span class="cart-count dn-counter bg-dark">
                                            {{ count(session('cart', [])) }}
                                        </span>
                    ...
                    <div class="mobile_nav">
                        <ul class="d-flex">
                            <li>
                                <a href="javascript:void(0);" onclick="openSearch()" class="text-light">
                                    <i class="lni lni-search-alt"></i>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#login" class="text-light">
                                    <i class="lni lni-user"></i>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" onclick="openWishlist()" class="text-light">
                            ...
                            <li>
                                <a href="javascript:void(0);" onclick="openCart()" class="text-light">
    ...
    <div class="container">
        <nav id="navigation" class="navigation navigation-landscape">
            <div class="nav-header">
                <div class="nav-toggle text-light" style="position:fixed; top: 35px; left: 10px;"></div>
                <div class="nav-menus-wrapper">
                    <ul class="nav-menu">
                    
                        <li class="relative parent-parent-menu-item">
                            <a href="javascript:void(0);" class="home-link ps-0">Home</a>
                            <ul class="nav-dropdown nav-submenu">
                                <li><a href="{{ url('/') }}" class="sub-menu-item">Home 1</a></li>
                                <li><a href="{{ url('/home-2') }}" class="sub-menu-item">Home 2</a></li>
                                <li><a href="{{ url('/home-3') }}" class="sub-menu-item">Home 3</a></li>
                                <li><a href="{{ url('/home-4') }}" class="sub-menu-item">Home 4</a></li>
                                <li><a href="{{ url('/home-5') }}" class="sub-menu-item">Home 5</a></li>
                                <li><a href="{{ url('/home-6') }}" class="sub-menu-item">Home 6</a></li>
                                <li><a href="{{ url('/home-7') }}" class="sub-menu-item">Home 7</a></li>
                                <li><a href="{{ url('/home-8') }}" class="sub-menu-item">Home 8</a></li>
                                <li><a href="{{ url('/home-9') }}" class="sub-menu-item">Home 9</a></li>
                                <li><a href="{{ url('/home-10') }}" class="sub-menu-item">Home 10</a></li>
                                <li><a href="{{ url('/home-11') }}" class="sub-menu-item">Home 11</a></li>
                                <li><a href="{{ url('/home-12') }}" class="sub-menu-item">Home 12</a></li>
                                <li><a href="{{ url('/home-13') }}" class="sub-menu-item">Home 13</a></li>
                                <li><a href="{{ url('/home-14') }}" class="sub-menu-item">Home 14</a></li>
                                <li><a href="{{ url('/home-15') }}" class="sub-menu-item">Home 15</a></li>
                                <li><a href="{{ url('/home-16') }}" class="sub-menu-item">Home 16</a></li>
                        ...
                        <li class="relative parent-parent-menu-item">
                            ...
                            <ul class="nav-dropdown nav-submenu">
                                <li class="relative parent-menu-item"><a href="javascript:void(0);">Account Dashboard</a>
                                    <ul class="nav-dropdown nav-submenu">
                                        <li><a href="{{ url('/my-orders') }}" class="sub-menu-item">My Order</a></li>
                                        <li><a href="{{ url('/wishlist') }}" class="sub-menu-item">Wishlist</a></li>
                                        <li><a href="{{ url('/profile-info') }}" class="sub-menu-item">Profile Info</a></li>
                                        <li><a href="{{ url('/addresses') }}" class="sub-menu-item">Addresses</a></li>
                                        <li><a href="{{ url('/payment-method') }}" class="sub-menu-item">Payment Method</a></li>
                                    </ul>
                                </li>
                            ...
                            <ul class="nav-dropdown nav-submenu">
                                ...
                                <li class="relative parent-menu-item"><a href="javascript:void(0);">Email Template</a>
                                    <ul class="nav-dropdown nav-submenu">
                                        ...
                                        <li><a href="{{ url('/email-cart') }}" class="sub-menu-item">Cart</a></li>
                                        <li><a href="{{ url('/email-offers') }}" class="sub-menu-item">Offers</a></li>
                                        <li><a href="{{ url('/email-order-success') }}" class="sub-menu-item">Order Success</a></li>
                                        <li><a href="{{ url('/email-gift-voucher') }}" class="sub-menu-item">Gift Voucher</a></li>
                                        <li><a href="{{ url('/email-reset-password') }}" class="sub-menu-item">Reset Password</a></li>
                                        <li><a href="{{ url('/email-item-review') }}" class="sub-menu-item">Item Review</a></li>
                                    </ul>
                                </li>
                                <li class="relative parent-menu-item"><a href="javascript:void(0);">Special</a>
                                    <ul class="nav-dropdown nav-submenu">
                                        <li><a href="{{ url('/comingsoon') }}" class="sub-menu-item">Comingsoon</a></li>
                                        <li><a href="{{ url('/maintenance') }}" class="sub-menu-item">Maintenance</a></li>
                                        <li><a href="{{ url('/404') }}" class="sub-menu-item">404 Page</a></li>
                                    </ul>
                                </li>
                                <li class="relative parent-menu-item"><a href="javascript:void(0);">Auth</a>
                                    <ul class="nav-dropdown nav-submenu">
                                        ...
                                        <li><a href="{{ url('/forgot-password') }}" class="sub-menu-item">Password Reset</a></li>
                                    </ul>
                                </li>
